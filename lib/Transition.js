...
var Transition = (function (_Component) {
  ...
  function Transition() {
    ...
    this._getEndStyles = function () {
      ...
      var childStyles = (0, _toRMStyles2['default'])(enter, _this.props.springParams);
    ...
    this._willEnter = function (key, value, endValue, currentValue, currentSpeed) {
      ...
      return _extends({}, value, (0, _toRMStyles2['default'])(childStyles,  _this.props.springParams));
    };
    ...
    this._willLeave = function (key, value, endValue, currentValue, currentSpeed) {
      ...
      return _extends({}, value, (0, _toRMStyles2['default'])(leave,  _this.props.springParams));
    };
